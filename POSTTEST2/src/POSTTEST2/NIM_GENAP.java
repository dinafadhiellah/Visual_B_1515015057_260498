 ...
 * @author RizkyKiwa
 */
public class NIM_GENAP extends javax.swing.JFrame {
String jk;
    /**
    ...
    private void initComponents() {
        ...
        jLabel14.setText("FORM DATA PENDUDUK ");

        jLabel1.setFont(new java.awt.Font("Times New Roman", 1, 18)); // NOI18N
        jLabel1.setText("KOTA BALIKPAPAN");
...
buttonGroup1.clearSelection();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NIM_GENAP.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
