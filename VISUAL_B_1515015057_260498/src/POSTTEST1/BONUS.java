...
public class BONUS extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        celcius.setBackground(new java.awt.Color(0, 102, 102));
        ...
        kelvin.setBackground(new java.awt.Color(0, 102, 102));
        ...
        farenheit.setBackground(new java.awt.Color(0, 102, 102));
        ...
        konversi.setBackground(new java.awt.Color(0, 0, 0));
        ...
        reamur.setBackground(new java.awt.Color(0, 102, 102));
